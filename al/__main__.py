...
def interactive():
    ...
    print("alohomora is used to find more details of the juicy secret keys that you found in the wild!\n")
...
def main():
    print('''%s
  __    _     ___   _     ___   _      ___   ___    __  
 / /\  | |   / / \ | |_| / / \ | |\/| / / \ | |_)  / /\ 
/_/--\ |_|__ \_\_/ |_| | \_\_/ |_|  | \_\_/ |_| \ /_/--\ %s %s
---
''' % (red, '1.0.0', end))
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="For any issues/concerns reach out to alohomora@cyfinoid.com"
    )
