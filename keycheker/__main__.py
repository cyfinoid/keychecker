...
from core.validate_ssh import is_password_protected, generate_public_key_with_comment, chmod_600
...
def ssh(args):
    ...
    try:
        ...
        chmod_600(args.filepath)
        is_password_protected(args.filepath)
        
    if args.generate_public_key == True:
        generate_public_key_with_comment(args.filepath)
    else:
        print("😔 Cannot generate SSH Public Key from the Private Key")
